...
@Component
public class ProductUpdateCrudOperationStrategy extends AbstractCrudOperationStrategy<ProductService, ProductPayload> {
    @Autowired
    private ProductService productService;

    public ProductUpdateCrudOperationStrategy() {
        super(CrudOperationConstants.UPDATE, ProductService.class, ProductPayload.class);
    }

    @Override
    protected void processInternal(ProductPayload payload) {
        productService.updateProduct(payload.id().toString(), payload);
    }
}
