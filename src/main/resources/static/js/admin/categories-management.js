        ...
        new PopupManager()
            ...
            .setSubmitAction(async () => {
                try {
                    ...
                    console.error(error);
                    notification.showNotification('Управление категориями',
                        `Во время создания категории произошла ошибка. ${error.message}`);
                }
            })
            .createPopup();
    });
            ...
            new PopupManager()
                ...
                .setSubmitAction(async () => {
                    try {
                        ...
                        console.error(error);
                        notification.showNotification('Управление категориями',
                            `Во время изменения названия категории произошла ошибка ${error.message}`);
                    }
                })
                .createPopup();
        });
