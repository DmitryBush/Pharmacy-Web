...
import com.bush.pharmacy_web_app.service.product.mapper.ProductCreateMapper;
...
public class ProductService {
    ...
    public List<ProductPreviewReadDto> findAllPreviews() {
        return productRepository.findAll().stream()
                .map(productReadMapper::mapToMedicinePreviewReadDto)
                .toList();
    }

    public Page<ProductPreviewReadDto> findAllPreviews(ProductFilter filter, Pageable pageable) {
        return productRepository.findAllByFilter(filter, pageable)
                .map(productReadMapper::mapToMedicinePreviewReadDto);
    }

    public List<ProductPreviewReadDto> findRandomMedicine(Integer count) {
    ...
    public List<ProductPreviewReadDto> findByContainingName(String name) {
    ...
    @Transactional
    public ProductPreviewReadDto createMedicine(ProductCreateDto createDto, List<MultipartFile> images) {
