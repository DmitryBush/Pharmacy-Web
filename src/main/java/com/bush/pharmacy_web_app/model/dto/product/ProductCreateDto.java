...
public record ProductCreateDto(Long id,
                               @NotNull @NotBlank @Length(max = 256) String name,
                               ...
                               @NotNull @NotBlank @Length(max = 128) String activeIngredient,
                               @NotNull @NotBlank @Length(max = 64) String expirationDate,
                               String composition,
                               String indication,
